...
public class ASTImpl {
    ...
    public void scan(String file){
        ...
        //Asignment of the tesk required by the compiler to procces the objects collected from the File
        JavaCompiler.CompilationTask task = compiler.getTask(null, fileManager, diagnosticsCollector, null, null, fileObjects);

        //Initiation of Javac compiler taks and association with the CompilationTask
